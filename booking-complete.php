...
$userphone = $userfetch["ptel"]; // Assuming 'ptel' is the phone number column
...
if ($conn->query($sql) === TRUE) {
    ...
    try {
     ...
     // Assume these variables are defined from your form data
    $amount = 1500; // Replace with actual amount
    $account_reference = $apponum; // Replace with relevant reference

    // Fetch user's phone number from the database
    $phone_number = $userfetch['ptel']; // Make sure 'ptel' is the correct column for phone number
    ...
    $amount = 1500; // Example amount, replace with actual amount
    $mpesa_response = sendMpesaSTKPush($userphone, $amount, $apponum);
