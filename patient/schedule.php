...
<head>
    ...
    <style>
        ...
        @media (min-width: 768px) {
            .search-items {
                width: 48%; /* Adjust for padding and margin */
            }
        }
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <tbody>
    <?php
        // Assuming that $result has been set by an SQL query that includes `speciality_name` from the doctor table
        if($result->num_rows == 0){
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $speciality_name = $row["speciality_name"]; // Fetch the specialty name
                    ...
                    <td style="width: 25%;">
                        <div class="dashboard-items search-items">
                            <div style="width:100%">
                                ...
                                <div class="h4-search">
                                    '.$speciality_name.'<br>'.$scheduledate.'<br>Starts: <b>@'.substr($scheduletime,0,5).'</b>
                                </div>
                                <br>
